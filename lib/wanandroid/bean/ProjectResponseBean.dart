class ProjectResponseBean {
  ProjectListBean data;
  int errorCode;
  String errorMsg;

  ProjectResponseBean({this.data, this.errorCode, this.errorMsg});

  ProjectResponseBean.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new ProjectListBean.fromJson(json['data']) : null;
...
class ProjectListBean {
  ...
  ProjectListBean.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = new List<ProjectBean>();
      json['datas'].forEach((v) {
        datas.add(new ProjectBean.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
