class ArticleResponseBean {
  ArticleListBean data;
  int errorCode;
  String errorMsg;

  ArticleResponseBean({this.data, this.errorCode, this.errorMsg});

  ArticleResponseBean.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new ArticleListBean.fromJson(json['data']) : null;
